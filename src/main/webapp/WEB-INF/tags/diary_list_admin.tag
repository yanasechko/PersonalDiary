...
<%@tag import="com.diary.model.Diary"%>
...
<tr>
    ...
    <td>
        ...
        <a href="delete?diary_id=<%=diary.getId()%>" class="btn-floating btn-small waves-effect waves-light red" onclick="return confirm('Вы уверены?');">
