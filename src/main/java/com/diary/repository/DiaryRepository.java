...
import com.diary.contracts.IDiaryRepository;
...
public class DiaryRepository implements IDiaryRepository<Diary, Integer> {

    private final IUserRepository database;

    public DiaryRepository(IUserRepository database) {
