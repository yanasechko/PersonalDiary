...
import com.diary.repository.MySQL;
...
public class Helper {
    ...
    public static String DB_SOURCE = "jdbc:mysql://localhost:3306/jspDiary?useSSL=false&serverTimezone=UTC&user=root&password=24356879q&charset=UTF-8";
    private static IUserRepository DATABASE = null;
    ...
    private static IUserRepository getMySQLDatabase() {
